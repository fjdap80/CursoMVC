...
namespace CapaNegocio
{
    public class CN_Cliente
    {
        ...
        public int Registrar(Cliente obj, out string Mensaje)
        {
            ...
            {
                obj.Clave = CN_Recursos.ConvertirSha256(obj.Clave); //propiedad donde almacena la contraseña
        ...
        {
            return objCapaDato.Listar(); //Retorna un método que está en la clase CD_Cliente
        }
